#------------------------------------------#
# Title: IO Classes
# Desc: LAB-09B Module for IO Classes
# Change Log: (Who, When, What)
# DBiesinger, 2030-Jan-01, Created File
# DBiesinger, 2030-Jan-02, Extended functionality to add tracks
# EADotson  , 2020-March-19, Completing ToDO's using Foundations document and previous assignments
# EADotson  , 2020-March-19, Test and adding Error Handling
#------------------------------------------#
...
class FileIO:
    ...
    def save_inventory(file_name: list, lst_Inventory: list) -> None:
        ...
        # TO-Done modify method to accept a list of file names.
        try:
            with open(file_name_CD, 'w') as file:
                for disc in lst_Inventory:
                    file.write(disc.get_record())
            # TO-Done add code to save track data to file
...
class ScreenIO:
    ...
    def menu_choice():
        ...
        try:
            ...
            print(type(e))
            print('Please type one of the offered options')
        else:
        ...
        while ValueError:
            try:
                ...
                break
                 ...
                 cdId = input('ID must be numeric,  Enter ID: ').strip()
    ...
    def get_track_info():
        ...
        while True:
            try:
                ...
                print(('Please enter Position using positive integers'))
            else:
                continue
