#------------------------------------------#
# Title: Data Classes
# Desc: LAB-09B Module for Data Classes
...
# EADotson  , 2020-March-19, Added code fulfilling the ToDo's ans test it/ fixed copying issues
# with indentation
# Tried to incorporate verifications Test and adding Error Handling
#------------------------------------------#
